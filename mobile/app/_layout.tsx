...
import { Gradients } from '@shared/themes/colors';

const TransparentDefaultTheme = {
...
export default function RootLayout() {
  ...
  return (
    <LinearGradient colors={Gradients.Gradient1 as [string, string]} style={{ flex: 1 }}>
      <SWRConfig
        value={{
          ...
          <AskPasswordContextProvider>
            <AccountNumberContextProvider storage={LayerzStorage} backgroundCaller={BackgroundExecutor}>
              <NetworkContextProvider storage={LayerzStorage} backgroundCaller={BackgroundExecutor}>
                <ThemeProvider value={colorScheme === 'dark' ? TransparentDarkTheme : TransparentDefaultTheme}>
                  <Stack>
